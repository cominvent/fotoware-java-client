 ...
 */
@JsonPropertyOrder({
  DeleteRequest.JSON_PROPERTY_ASSETS
})
...
public class DeleteRequest {
  ...
  public DeleteRequest assets(List<ActionRequestAssetsInner> assets) {
    this.assets = assets;
    return this;
  }

  public DeleteRequest addAssetsItem(ActionRequestAssetsInner assetsItem) {
    if (this.assets == null) {
  ...
  **/
  ...
  /**
   * Return true if this DeleteRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assets, deleteRequest.assets);
  }
