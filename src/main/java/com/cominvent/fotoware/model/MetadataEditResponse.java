...
public class MetadataEditResponse {
  ...
  **/
  ...
  public MetadataEditResponse location(String location) {
  ...
  **/
  ...
  public MetadataEditResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this MetadataEditResponse object is equal to o.
   */
  @Override
