 ...
 */
@JsonPropertyOrder({
  DuplicateRequest.JSON_PROPERTY_ASSETS
})
...
public class DuplicateRequest {
  ...
  public DuplicateRequest assets(List<ActionRequestAssetsInner> assets) {
    this.assets = assets;
    return this;
  }

  public DuplicateRequest addAssetsItem(ActionRequestAssetsInner assetsItem) {
    if (this.assets == null) {
  ...
  **/
  ...
  /**
   * Return true if this DuplicateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assets, duplicateRequest.assets);
  }
