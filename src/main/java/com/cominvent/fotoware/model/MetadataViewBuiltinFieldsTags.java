...
import com.cominvent.fotoware.model.MetadataViewBuiltinFieldsTagsField;
 ...
 */
@JsonPropertyOrder({
  MetadataViewBuiltinFieldsTags.JSON_PROPERTY_FIELD,
  MetadataViewBuiltinFieldsTags.JSON_PROPERTY_TAXONOMY_ONLY,
  MetadataViewBuiltinFieldsTags.JSON_PROPERTY_IS_WRITABLE,
  MetadataViewBuiltinFieldsTags.JSON_PROPERTY_REQUIRED
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class MetadataViewBuiltinFieldsTags {
  public static final String JSON_PROPERTY_FIELD = "field";
  private MetadataViewBuiltinFieldsTagsField field;
  ...
  public MetadataViewBuiltinFieldsTags() { 
  }

  public MetadataViewBuiltinFieldsTags field(MetadataViewBuiltinFieldsTagsField field) {
    this.field = field;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField getField() {
    return field;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FIELD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setField(MetadataViewBuiltinFieldsTagsField field) {
    this.field = field;
  }


  public MetadataViewBuiltinFieldsTags taxonomyOnly(Boolean taxonomyOnly) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTags isWritable(Boolean isWritable) {
    this.isWritable = isWritable;
    return this;
  }

   /**
   * true if the field may be edited in metadata update and upload requests. false if the field is read-only
   * @return isWritable
  **/
  @jakarta.annotation.Nullable
  ...
  public MetadataViewBuiltinFieldsTags required(Boolean required) {
  ...
  **/
  ...
  /**
   * Return true if this MetadataView_builtinFields_tags object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MetadataViewBuiltinFieldsTags metadataViewBuiltinFieldsTags = (MetadataViewBuiltinFieldsTags) o;
    return Objects.equals(this.field, metadataViewBuiltinFieldsTags.field) &&
        Objects.equals(this.taxonomyOnly, metadataViewBuiltinFieldsTags.taxonomyOnly) &&
        Objects.equals(this.isWritable, metadataViewBuiltinFieldsTags.isWritable) &&
        Objects.equals(this.required, metadataViewBuiltinFieldsTags.required);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetadataViewBuiltinFieldsTags {\n");
