 ...
 */
@JsonPropertyOrder({
  Paging.JSON_PROPERTY_PREV,
  Paging.JSON_PROPERTY_NEXT,
  Paging.JSON_PROPERTY_FIRST,
  Paging.JSON_PROPERTY_LAST
})
...
public class Paging {
  ...
  public Paging prev(String prev) {
    this.prev = prev;
    return this;
  }
  ...
  **/
  ...
  public Paging next(String next) {
   ...
   /**
   * URL of next page. If null, then there is no next page, and the current representation is the last page.
   * @return next
  **/
  @jakarta.annotation.Nullable
  ...
  **/
  ...
  public Paging last(String last) {
    this.last = last;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.prev, paging.prev) &&
        Objects.equals(this.next, paging.next) &&
        Objects.equals(this.first, paging.first) &&
        Objects.equals(this.last, paging.last);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prev, next, first, last);
  }
