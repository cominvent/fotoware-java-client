...
import com.cominvent.fotoware.model.CollectionInfoClearSearch;
import com.cominvent.fotoware.model.CollectionInfoMetadataEditor;
 ...
 */
@JsonPropertyOrder({
  CollectionInfo.JSON_PROPERTY_ANCESTORS,
  CollectionInfo.JSON_PROPERTY_ALERT_HREF,
  CollectionInfo.JSON_PROPERTY_ALT_ORDERS,
  CollectionInfo.JSON_PROPERTY_ARCHIVED,
  CollectionInfo.JSON_PROPERTY_CAN_BE_ARCHIVED,
  CollectionInfo.JSON_PROPERTY_CAN_BE_DELETED,
  CollectionInfo.JSON_PROPERTY_CAN_COPY_TO,
  CollectionInfo.JSON_PROPERTY_CAN_CREATE_FOLDERS,
  CollectionInfo.JSON_PROPERTY_CAN_HAVE_CHILDREN,
  CollectionInfo.JSON_PROPERTY_CAN_INGEST_TO_CHILDREN,
  CollectionInfo.JSON_PROPERTY_CAN_MOVE_TO,
  CollectionInfo.JSON_PROPERTY_CAN_SELECT,
  CollectionInfo.JSON_PROPERTY_CAN_UPLOAD_TO,
  CollectionInfo.JSON_PROPERTY_CLEAR_SEARCH,
  CollectionInfo.JSON_PROPERTY_CREATE,
  CollectionInfo.JSON_PROPERTY_CREATED,
  CollectionInfo.JSON_PROPERTY_DATA,
  CollectionInfo.JSON_PROPERTY_DATA_TEMPLATE,
  CollectionInfo.JSON_PROPERTY_DELETED,
  CollectionInfo.JSON_PROPERTY_DESCRIPTION,
  CollectionInfo.JSON_PROPERTY_EDIT,
  CollectionInfo.JSON_PROPERTY_HAS_CHILDREN,
  CollectionInfo.JSON_PROPERTY_HREF,
  CollectionInfo.JSON_PROPERTY_IS_FOLDER_NAVIGATION_ENABLED,
  CollectionInfo.JSON_PROPERTY_IS_LINK_COLLECTION,
  CollectionInfo.JSON_PROPERTY_IS_SEARCHABLE,
  CollectionInfo.JSON_PROPERTY_IS_SELECTABLE,
  CollectionInfo.JSON_PROPERTY_IS_SMART_FOLDER_NAVIGATION_ENABLED,
  CollectionInfo.JSON_PROPERTY_MATCHING_HREF,
  CollectionInfo.JSON_PROPERTY_METADATA_EDITOR,
  CollectionInfo.JSON_PROPERTY_MODIFIED,
  CollectionInfo.JSON_PROPERTY_NAME,
  CollectionInfo.JSON_PROPERTY_ORDER_ROOT_HREF,
  CollectionInfo.JSON_PROPERTY_ORIGINAL_U_R_L,
  CollectionInfo.JSON_PROPERTY_PERMISSIONS,
  CollectionInfo.JSON_PROPERTY_PIN,
  CollectionInfo.JSON_PROPERTY_POSTER_ASSET,
  CollectionInfo.JSON_PROPERTY_POSTER_IMAGES,
  CollectionInfo.JSON_PROPERTY_PROPERTY_VALIDATIONS,
  CollectionInfo.JSON_PROPERTY_PROPS,
  CollectionInfo.JSON_PROPERTY_REORDER,
  CollectionInfo.JSON_PROPERTY_SEARCH_QUERY,
  CollectionInfo.JSON_PROPERTY_SEARCH_STRING,
  CollectionInfo.JSON_PROPERTY_SEARCH_U_R_L,
  CollectionInfo.JSON_PROPERTY_SMART_FOLDER_HEADER,
  CollectionInfo.JSON_PROPERTY_TAXONOMIES,
  CollectionInfo.JSON_PROPERTY_TYPE,
  CollectionInfo.JSON_PROPERTY_UPLOAD_HREF
})
...
public class CollectionInfo {
  ...
  private CollectionInfoClearSearch clearSearch;
  ...
  private CollectionInfoMetadataEditor metadataEditor;
  ...
  public CollectionInfo ancestors(List<AssetAncestorsInner> ancestors) {
    this.ancestors = ancestors;
    return this;
  }

  public CollectionInfo addAncestorsItem(AssetAncestorsInner ancestorsItem) {
   ...
   /**
   * Lists the collection to which the asset belongs, is parent collection and the remaining ancestors in the collection hierarchy. Can be used for rendering a breadcrumb, implementing an \&quot;up\&quot; button or finding the collection to which this instance of the asset belongs. 
   * @return ancestors
  **/
  ...
  public CollectionInfo alertHref(Object alertHref) {
  ...
  **/
  ...
  public CollectionInfo altOrders(List<CollectionAltOrdersInner> altOrders) {
    this.altOrders = altOrders;
    return this;
  }

  public CollectionInfo addAltOrdersItem(CollectionAltOrdersInner altOrdersItem) {
  ...
  **/
  ...
  public CollectionInfo archived(String archived) {
  ...
  **/
  ...
  public CollectionInfo canBeArchived(Boolean canBeArchived) {
  ...
  **/
  ...
  public CollectionInfo canBeDeleted(Boolean canBeDeleted) {
  ...
  **/
  ...
  public CollectionInfo canCopyTo(Boolean canCopyTo) {
  ...
  **/
  ...
  public CollectionInfo canCreateFolders(Boolean canCreateFolders) {
  ...
  **/
  ...
  public CollectionInfo canHaveChildren(Boolean canHaveChildren) {
  ...
  **/
  ...
  public CollectionInfo canIngestToChildren(Boolean canIngestToChildren) {
  ...
  **/
  ...
  public CollectionInfo canMoveTo(Boolean canMoveTo) {
  ...
  **/
  ...
  public CollectionInfo canSelect(Boolean canSelect) {
  ...
  **/
  ...
  public CollectionInfo canUploadTo(Boolean canUploadTo) {
  ...
  **/
  ...
  public CollectionInfo clearSearch(CollectionInfoClearSearch clearSearch) {
  ...
  **/
  ...
  public CollectionInfoClearSearch getClearSearch() {
    return clearSearch;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CLEAR_SEARCH)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setClearSearch(CollectionInfoClearSearch clearSearch) {
    this.clearSearch = clearSearch;
  }


  public CollectionInfo create(List<CollectionCreateInner> create) {
    this.create = create;
    return this;
  }

  public CollectionInfo addCreateItem(CollectionCreateInner createItem) {
    if (this.create == null) {
  ...
  **/
  ...
  public CollectionInfo created(String created) {
  ...
  **/
  ...
  public CollectionInfo data(String data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public CollectionInfo dataTemplate(String dataTemplate) {
  ...
  **/
  ...
  public CollectionInfo deleted(String deleted) {
  ...
  **/
  ...
  public CollectionInfo edit(Boolean edit) {
    this.edit = edit;
    return this;
  }
  ...
  **/
  ...
  public CollectionInfo hasChildren(Boolean hasChildren) {
  ...
  **/
  ...
  public CollectionInfo href(String href) {
    this.href = href;
    return this;
  }

   /**
   * Canonical public URL of the collection.
   * @return href
  **/
  @jakarta.annotation.Nullable
  ...
  public CollectionInfo isFolderNavigationEnabled(Boolean isFolderNavigationEnabled) {
  ...
  **/
  ...
  public CollectionInfo isLinkCollection(Boolean isLinkCollection) {
  ...
  **/
  ...
  public CollectionInfo isSearchable(Boolean isSearchable) {
  ...
  **/
  ...
  public CollectionInfo isSelectable(Boolean isSelectable) {
  ...
  **/
  ...
  public CollectionInfo isSmartFolderNavigationEnabled(Boolean isSmartFolderNavigationEnabled) {
    this.isSmartFolderNavigationEnabled = isSmartFolderNavigationEnabled;
    return this;
  }

   /**
   * Get isSmartFolderNavigationEnabled
  ...
  **/
  ...
  public CollectionInfo matchingHref(String matchingHref) {
  ...
  **/
  ...
  public CollectionInfo metadataEditor(CollectionInfoMetadataEditor metadataEditor) {
  ...
  **/
  ...
  public CollectionInfoMetadataEditor getMetadataEditor() {
    return metadataEditor;
  }
  ...
  @JsonProperty(JSON_PROPERTY_METADATA_EDITOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadataEditor(CollectionInfoMetadataEditor metadataEditor) {
    this.metadataEditor = metadataEditor;
  }


  public CollectionInfo modified(String modified) {
  ...
  **/
  ...
  public CollectionInfo orderRootHref(String orderRootHref) {
  ...
  **/
  ...
  public CollectionInfo originalURL(String originalURL) {
  ...
  **/
  ...
  public CollectionInfo permissions(List<Permission> permissions) {
    this.permissions = permissions;
    return this;
  }

  public CollectionInfo addPermissionsItem(Permission permissionsItem) {
  ...
  **/
  ...
  public CollectionInfo pin(Object pin) {
  ...
  **/
  ...
  public CollectionInfo posterAsset(String posterAsset) {
  ...
  **/
  ...
  public CollectionInfo posterImages(List<AssetPreviewsInner> posterImages) {
    this.posterImages = posterImages;
    return this;
  }

  public CollectionInfo addPosterImagesItem(AssetPreviewsInner posterImagesItem) {
  ...
  **/
  ...
  public CollectionInfo propertyValidations(List<CollectionPropertyValidationsInner> propertyValidations) {
    this.propertyValidations = propertyValidations;
    return this;
  }

  public CollectionInfo addPropertyValidationsItem(CollectionPropertyValidationsInner propertyValidationsItem) {
  ...
  **/
  ...
  public CollectionInfo props(CollectionProps props) {
    this.props = props;
    return this;
  }
  ...
  **/
  ...
  public CollectionInfo reorder(Object reorder) {
  ...
  **/
  ...
  public CollectionInfo searchQuery(String searchQuery) {
  ...
  **/
  ...
  public CollectionInfo searchString(String searchString) {
  ...
  **/
  ...
  public CollectionInfo searchURL(String searchURL) {
  ...
  **/
  ...
  public CollectionInfo smartFolderHeader(String smartFolderHeader) {
    this.smartFolderHeader = smartFolderHeader;
    return this;
  }

   /**
   * Get smartFolderHeader
  ...
  **/
  ...
  public CollectionInfo taxonomies(List<Taxonomy> taxonomies) {
    this.taxonomies = taxonomies;
    return this;
  }

  public CollectionInfo addTaxonomiesItem(Taxonomy taxonomiesItem) {
  ...
  **/
  ...
  public CollectionInfo type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public CollectionInfo uploadHref(String uploadHref) {
  ...
  **/
  ...
  /**
   * Return true if this CollectionInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ancestors, collectionInfo.ancestors) &&
        equalsNullable(this.alertHref, collectionInfo.alertHref) &&
        Objects.equals(this.altOrders, collectionInfo.altOrders) &&
        Objects.equals(this.archived, collectionInfo.archived) &&
        Objects.equals(this.canBeArchived, collectionInfo.canBeArchived) &&
        Objects.equals(this.canBeDeleted, collectionInfo.canBeDeleted) &&
        Objects.equals(this.canCopyTo, collectionInfo.canCopyTo) &&
        Objects.equals(this.canCreateFolders, collectionInfo.canCreateFolders) &&
        Objects.equals(this.canHaveChildren, collectionInfo.canHaveChildren) &&
        Objects.equals(this.canIngestToChildren, collectionInfo.canIngestToChildren) &&
        Objects.equals(this.canMoveTo, collectionInfo.canMoveTo) &&
        Objects.equals(this.canSelect, collectionInfo.canSelect) &&
        Objects.equals(this.canUploadTo, collectionInfo.canUploadTo) &&
        Objects.equals(this.clearSearch, collectionInfo.clearSearch) &&
        Objects.equals(this.create, collectionInfo.create) &&
        Objects.equals(this.created, collectionInfo.created) &&
        Objects.equals(this.data, collectionInfo.data) &&
        Objects.equals(this.dataTemplate, collectionInfo.dataTemplate) &&
        Objects.equals(this.deleted, collectionInfo.deleted) &&
        Objects.equals(this.description, collectionInfo.description) &&
        Objects.equals(this.edit, collectionInfo.edit) &&
        Objects.equals(this.hasChildren, collectionInfo.hasChildren) &&
        Objects.equals(this.href, collectionInfo.href) &&
        Objects.equals(this.isFolderNavigationEnabled, collectionInfo.isFolderNavigationEnabled) &&
        Objects.equals(this.isLinkCollection, collectionInfo.isLinkCollection) &&
        Objects.equals(this.isSearchable, collectionInfo.isSearchable) &&
        Objects.equals(this.isSelectable, collectionInfo.isSelectable) &&
        Objects.equals(this.isSmartFolderNavigationEnabled, collectionInfo.isSmartFolderNavigationEnabled) &&
        Objects.equals(this.matchingHref, collectionInfo.matchingHref) &&
        Objects.equals(this.metadataEditor, collectionInfo.metadataEditor) &&
        Objects.equals(this.modified, collectionInfo.modified) &&
        Objects.equals(this.name, collectionInfo.name) &&
        Objects.equals(this.orderRootHref, collectionInfo.orderRootHref) &&
        Objects.equals(this.originalURL, collectionInfo.originalURL) &&
        Objects.equals(this.permissions, collectionInfo.permissions) &&
        equalsNullable(this.pin, collectionInfo.pin) &&
        Objects.equals(this.posterAsset, collectionInfo.posterAsset) &&
        Objects.equals(this.posterImages, collectionInfo.posterImages) &&
        Objects.equals(this.propertyValidations, collectionInfo.propertyValidations) &&
        Objects.equals(this.props, collectionInfo.props) &&
        equalsNullable(this.reorder, collectionInfo.reorder) &&
        Objects.equals(this.searchQuery, collectionInfo.searchQuery) &&
        Objects.equals(this.searchString, collectionInfo.searchString) &&
        Objects.equals(this.searchURL, collectionInfo.searchURL) &&
        Objects.equals(this.smartFolderHeader, collectionInfo.smartFolderHeader) &&
        Objects.equals(this.taxonomies, collectionInfo.taxonomies) &&
        Objects.equals(this.type, collectionInfo.type) &&
        Objects.equals(this.uploadHref, collectionInfo.uploadHref);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ancestors, hashCodeNullable(alertHref), altOrders, archived, canBeArchived, canBeDeleted, canCopyTo, canCreateFolders, canHaveChildren, canIngestToChildren, canMoveTo, canSelect, canUploadTo, clearSearch, create, created, data, dataTemplate, deleted, description, edit, hasChildren, href, isFolderNavigationEnabled, isLinkCollection, isSearchable, isSelectable, isSmartFolderNavigationEnabled, matchingHref, metadataEditor, modified, name, orderRootHref, originalURL, permissions, hashCodeNullable(pin), posterAsset, posterImages, propertyValidations, props, hashCodeNullable(reorder), searchQuery, searchString, searchURL, smartFolderHeader, taxonomies, type, uploadHref);
  }
