 ...
 */
@JsonPropertyOrder({
  MetadataViewBuiltinFieldsRatingField.JSON_PROPERTY_MAX_SIZE,
  MetadataViewBuiltinFieldsRatingField.JSON_PROPERTY_MULTILINE,
  MetadataViewBuiltinFieldsRatingField.JSON_PROPERTY_DATA_TYPE,
  MetadataViewBuiltinFieldsRatingField.JSON_PROPERTY_VALIDATION,
  MetadataViewBuiltinFieldsRatingField.JSON_PROPERTY_ID,
...
public class MetadataViewBuiltinFieldsRatingField {
  ...
  public MetadataViewBuiltinFieldsRatingField() { 
  }

  public MetadataViewBuiltinFieldsRatingField maxSize(Integer maxSize) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsRatingField multiline(Boolean multiline) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsRatingField dataType(String dataType) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsRatingField validation(Object validation) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsRatingField id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsRatingField label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsRatingField multiInstance(Boolean multiInstance) {
  ...
  **/
  ...
  /**
   * Return true if this MetadataView_builtinFields_rating_field object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MetadataViewBuiltinFieldsRatingField metadataViewBuiltinFieldsRatingField = (MetadataViewBuiltinFieldsRatingField) o;
    return Objects.equals(this.maxSize, metadataViewBuiltinFieldsRatingField.maxSize) &&
        Objects.equals(this.multiline, metadataViewBuiltinFieldsRatingField.multiline) &&
        Objects.equals(this.dataType, metadataViewBuiltinFieldsRatingField.dataType) &&
        Objects.equals(this.validation, metadataViewBuiltinFieldsRatingField.validation) &&
        Objects.equals(this.id, metadataViewBuiltinFieldsRatingField.id) &&
        Objects.equals(this.label, metadataViewBuiltinFieldsRatingField.label) &&
        Objects.equals(this.multiInstance, metadataViewBuiltinFieldsRatingField.multiInstance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxSize, multiline, dataType, validation, id, label, multiInstance);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetadataViewBuiltinFieldsRatingField {\n");
