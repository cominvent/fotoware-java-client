 ...
 */
@JsonPropertyOrder({
  TaxonomyItemInfo.JSON_PROPERTY_NAME,
  TaxonomyItemInfo.JSON_PROPERTY_DESCRIPTION,
  TaxonomyItemInfo.JSON_PROPERTY_HAS_CHILDREN,
  TaxonomyItemInfo.JSON_PROPERTY_FIELD,
  TaxonomyItemInfo.JSON_PROPERTY_HREF,
  TaxonomyItemInfo.JSON_PROPERTY_TAXONOMY_HREF,
  TaxonomyItemInfo.JSON_PROPERTY_ACL,
  TaxonomyItemInfo.JSON_PROPERTY_VALUE,
  TaxonomyItemInfo.JSON_PROPERTY_CUSTOM_SEARCH
})
...
public class TaxonomyItemInfo {
  ...
  public TaxonomyItemInfo() { 
  }

  public TaxonomyItemInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public TaxonomyItemInfo description(String description) {
  ...
  **/
  ...
  public TaxonomyItemInfo hasChildren(Boolean hasChildren) {
  ...
  **/
  ...
  public TaxonomyItemInfo field(Integer field) {
    this.field = field;
    return this;
  }
  ...
  **/
  ...
  public TaxonomyItemInfo href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public TaxonomyItemInfo taxonomyHref(String taxonomyHref) {
  ...
  **/
  ...
  public TaxonomyItemInfo acl(List<String> acl) {
    this.acl = acl;
    return this;
  }

  public TaxonomyItemInfo addAclItem(String aclItem) {
    if (this.acl == null) {
  ...
  **/
  ...
  public TaxonomyItemInfo value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public TaxonomyItemInfo customSearch(String customSearch) {
  ...
  **/
  ...
  /**
   * Return true if this TaxonomyItemInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TaxonomyItemInfo taxonomyItemInfo = (TaxonomyItemInfo) o;
    return Objects.equals(this.name, taxonomyItemInfo.name) &&
        Objects.equals(this.description, taxonomyItemInfo.description) &&
        Objects.equals(this.hasChildren, taxonomyItemInfo.hasChildren) &&
        Objects.equals(this.field, taxonomyItemInfo.field) &&
        Objects.equals(this.href, taxonomyItemInfo.href) &&
        Objects.equals(this.taxonomyHref, taxonomyItemInfo.taxonomyHref) &&
        Objects.equals(this.acl, taxonomyItemInfo.acl) &&
        Objects.equals(this.value, taxonomyItemInfo.value) &&
        Objects.equals(this.customSearch, taxonomyItemInfo.customSearch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, hasChildren, field, href, taxonomyHref, acl, value, customSearch);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TaxonomyItemInfo {\n");
