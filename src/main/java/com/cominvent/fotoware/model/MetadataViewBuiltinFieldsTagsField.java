 ...
 */
@JsonPropertyOrder({
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_ID,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_TAXONOMY_HREF,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_LABEL,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_MULTI_INSTANCE,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_MAX_SIZE,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_MULTILINE,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_DATA_TYPE,
  MetadataViewBuiltinFieldsTagsField.JSON_PROPERTY_VALIDATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class MetadataViewBuiltinFieldsTagsField {
  ...
  public MetadataViewBuiltinFieldsTagsField() { 
  }

  public MetadataViewBuiltinFieldsTagsField id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField taxonomyHref(String taxonomyHref) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField multiInstance(Boolean multiInstance) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField maxSize(Integer maxSize) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField multiline(Boolean multiline) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField dataType(String dataType) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTagsField validation(Object validation) {
  ...
  **/
  ...
  /**
   * Return true if this MetadataView_builtinFields_tags_field object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MetadataViewBuiltinFieldsTagsField metadataViewBuiltinFieldsTagsField = (MetadataViewBuiltinFieldsTagsField) o;
    return Objects.equals(this.id, metadataViewBuiltinFieldsTagsField.id) &&
        Objects.equals(this.taxonomyHref, metadataViewBuiltinFieldsTagsField.taxonomyHref) &&
        Objects.equals(this.label, metadataViewBuiltinFieldsTagsField.label) &&
        Objects.equals(this.multiInstance, metadataViewBuiltinFieldsTagsField.multiInstance) &&
        Objects.equals(this.maxSize, metadataViewBuiltinFieldsTagsField.maxSize) &&
        Objects.equals(this.multiline, metadataViewBuiltinFieldsTagsField.multiline) &&
        Objects.equals(this.dataType, metadataViewBuiltinFieldsTagsField.dataType) &&
        Objects.equals(this.validation, metadataViewBuiltinFieldsTagsField.validation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, taxonomyHref, label, multiInstance, maxSize, multiline, dataType, validation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetadataViewBuiltinFieldsTagsField {\n");
