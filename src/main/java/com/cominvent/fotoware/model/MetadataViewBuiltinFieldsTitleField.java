 ...
 */
@JsonPropertyOrder({
  MetadataViewBuiltinFieldsTitleField.JSON_PROPERTY_ID,
  MetadataViewBuiltinFieldsTitleField.JSON_PROPERTY_LABEL,
  MetadataViewBuiltinFieldsTitleField.JSON_PROPERTY_MULTI_INSTANCE,
  MetadataViewBuiltinFieldsTitleField.JSON_PROPERTY_MAX_SIZE,
  MetadataViewBuiltinFieldsTitleField.JSON_PROPERTY_MULTILINE,
...
public class MetadataViewBuiltinFieldsTitleField {
  ...
  public MetadataViewBuiltinFieldsTitleField() { 
  }

  public MetadataViewBuiltinFieldsTitleField id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTitleField label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTitleField multiInstance(Boolean multiInstance) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTitleField maxSize(Integer maxSize) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTitleField multiline(Boolean multiline) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTitleField dataType(String dataType) {
  ...
  **/
  ...
  public MetadataViewBuiltinFieldsTitleField validation(Object validation) {
  ...
  **/
  ...
  /**
   * Return true if this MetadataView_builtinFields_title_field object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MetadataViewBuiltinFieldsTitleField metadataViewBuiltinFieldsTitleField = (MetadataViewBuiltinFieldsTitleField) o;
    return Objects.equals(this.id, metadataViewBuiltinFieldsTitleField.id) &&
        Objects.equals(this.label, metadataViewBuiltinFieldsTitleField.label) &&
        Objects.equals(this.multiInstance, metadataViewBuiltinFieldsTitleField.multiInstance) &&
        Objects.equals(this.maxSize, metadataViewBuiltinFieldsTitleField.maxSize) &&
        Objects.equals(this.multiline, metadataViewBuiltinFieldsTitleField.multiline) &&
        Objects.equals(this.dataType, metadataViewBuiltinFieldsTitleField.dataType) &&
        Objects.equals(this.validation, metadataViewBuiltinFieldsTitleField.validation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, label, multiInstance, maxSize, multiline, dataType, validation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MetadataViewBuiltinFieldsTitleField {\n");
